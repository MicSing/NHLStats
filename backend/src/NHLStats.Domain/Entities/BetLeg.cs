...
public class BetLeg
{
    ...
    /// 0.80/0.75/0.70. 2.0, 2.1 and 2.2 all use the additive formula (odds = 1 + (1/probability - 1)
    /// * margin) — 2.0 is deliberately gentler (BettingConstants.HistoricalMargin), meant only for
    /// reconciling old settled tickets; 2.1 uses BettingConstants.Margin for everything; 2.2 is
    /// Margin minus a per-match random reduction (OddsFormula.MatchMargin), and is what new legs
    /// are stamped with at placement time.
    ...
    /// HistoricalOddsFormulaVersion / UniformOddsFormulaVersion / CurrentOddsFormulaVersion.
    /// </summary>
