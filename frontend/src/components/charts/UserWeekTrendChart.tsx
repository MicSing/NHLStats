    ...
    const allChartData = seasons.flatMap((s) =>
        s.weeks.map((w) => {
            ...
            return {
                ...
                matchCount: count,
                [avgPlusLabel]: count > 0 ? parseFloat((w.totalPlus / count).toFixed(1)) : 0,
                [avgMinusLabel]: count > 0 ? parseFloat((w.totalMinus / count).toFixed(1)) : 0,
                [avgGoalsLabel]: count > 0 ? parseFloat((w.goalCount / count).toFixed(1)) : 0,
